...
window.onload=function() {
	...
	var oInput=document.getElementById('search_input');
 	...
 	var web_or_mobile;
 	var tupianzhangshu=3;


	fangsuo(oBody,oHtml);
	oBeijing.style.backgroundImage="url('forfun/images/beijing/" + Math.ceil(Math.random()*tupianzhangshu) + ".jpg')";
	...
	if(browserRedirect(web_or_mobile) =='web'){
		...
		document.getElementById('tishi').innerHTML='<p><span></span></p><p><span>移动端正在开发中，pc更精彩！</span></p><p>bless you today</p>'
		setTimeout(function(){
			document.getElementById('tishi').style.cssText="display:none;";
		},10000);
